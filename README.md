...
You can view the website [here](https://randymarsh288.github.io/Deftones/)

Purpose
-------

The website was created for the Code Institute Diploma in Software Development Stream 1 project. The framework is based on code developed during the course lessons.
...
Functionality of the website has been tested on Google Chrome, Microsoft Edge and Mozilla Firefox at screen sizes down to 320px. The final code has been deployed to GitHub Pages.
